export const translations = {
  en: {
    ...
    gameInfo: {
      ...
      starsTitle: "Stars",
      starsLevelBody: "In level mode you earn up to 5 stars per level based on your accuracy: over 10%, 20%, 40%, 60% and 90% or higher.",
      starsRandomBody: "In random mode stars use the same accuracy bands but are based on how many questions you have answered correctly out of all 3300; the thresholds are much harder to reach.",
  ...
  fr: {
    ...
    gameInfo: {
      ...
      starsTitle: "Étoiles",
      starsLevelBody: "En mode Niveau vous gagnez jusqu'à 5 étoiles par niveau en fonction de votre précision : plus de 10 %, puis 20 %, 40 %, 60 % et 90 % ou plus.",
      starsRandomBody: "En mode Aléatoire les étoiles utilisent les mêmes bandes de pourcentage mais sont basées sur le nombre de questions que vous avez correctement répondues sur les 3300 au total ; les seuils sont donc beaucoup plus difficiles à atteindre.",
